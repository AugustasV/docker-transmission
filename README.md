...
### docker-compose ([recommende(https://docs.linuxserver.io/general/docker-compose))
...
### Via Docker Run
* Update the image: `docker pull ghcr.io/linuxserver/transmission`
...
docker build \
  --no-cache \
  --pull \
  -t ghcr.io/linuxserver/transmission:latest .
```
